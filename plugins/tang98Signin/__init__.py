...
class tang98Signin(_PluginBase):
    # 插件名称
    plugin_name = "98堂签到"
    # 插件描述
    plugin_desc = "98堂签到"
    # 插件图标
    plugin_icon = "98tang.png"
    # 插件版本
    plugin_version = "V1.0.0"
    # 插件作者
    plugin_author = "yideng"
    # 作者主页
    author_url = "https://github.com/yideng966"
    # 插件配置项ID前缀
    plugin_config_prefix = "tang98Signin_"
    # 加载顺序
    plugin_order = 24
    # 可使用的用户级别
    auth_level = 2
    ...
    def init_plugin(self, config: dict = None):
        ...
        if self._onlyonce:
            ...
            logger.info(f"98堂签到服务启动，立即运行一次")
